...
დაფორქე (fork) რეპოზიტორია (`s.s-semantic-10x-recap`) და შემდგომ ჩამოკლონე, სადაც მოგიწევს მუშაობა და დავალების ატვირთვა.
საქაღალდეში შექმენი დაამატე index.html ფაილი:
